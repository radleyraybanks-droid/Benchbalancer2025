...
/**
 * Calculates the optimal substitution pattern (times and player changes).
...
function calculateOptimalSubstitutionPattern(
    ...
    debugLog(`Calculating optimal substitution pattern for a DURATION of: ${formatTime(durationForThisPlanSegment)}`);
